...
class EightPuzzleProblem(searchProblem.SearchProblem):
    '''
    classdocs
    '''
    ...
    def __init__(self, initialState,goalState):
        ...
        Constructor
        '''
        self._initialState = eightPuzzleState.EightPuzzleState(initialState, '', 0) 
    ...
    def succesorFunction(self,cs): 
        ...
        if emptyRow != 0:
            ...
            ep = eightPuzzleState.EightPuzzleState(newState, 'Move Up', 1.0)
            nextMoves.append(ep) 
        ...
        if emptyRow + 1 != self._numberOfRows:
            ...
            newState[emptyRow + 1][emptyColumn] = 0
            newState[emptyRow][emptyColumn] = tempS
            ep = eightPuzzleState.EightPuzzleState(newState, 'Move Down', 1.0)
            nextMoves.append(ep)
        ...
        if emptyColumn != 0:
            ...
            newState[emptyRow][emptyColumn] = tempS
            ep = eightPuzzleState.EightPuzzleState(newState, 'Move Left', 1.0)
            nextMoves.append(ep)
        ...
        if emptyColumn +1 != self._numberOfColumns:
            ...
            newState[emptyRow][emptyColumn+1] = 0
            newState[emptyRow][emptyColumn] = tempS
            ep = eightPuzzleState.EightPuzzleState(newState, 'Move Right', 1.0)
            nextMoves.append(ep)
